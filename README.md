...
Tested using llama3.2 and lama3.2:1b locally on 1 epoch with the temperature set to 0. Because of limitations when testing locally I set the timeout=60 and used a sample size of 25 questions. 
...
Llama 3.2:1b did not see any changes in accuracy regardless of if few shot examples or tool use were introduced. This again may be due to the fact that the model is very small. Issues may include the complexity of tool use and using too much of the context window with prompts and few shot examples.
